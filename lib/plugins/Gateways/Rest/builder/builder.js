...
const buildRoute = (route, schema, operations, api, wire, uri) => {
	...
	Object.entries(operations).forEach(([method, operation]) => {
		operation = normalizers.operationDefintion(array.toFlatIfArray(operation, o => buildOperation(o, api)), schema);
		wire.triggerHook('onRoute', {
			uri,
			method,
			operation,
		});
		route[method](array.toFlatIfArray(operation.handler, o => o.handler || o));
	});
};
