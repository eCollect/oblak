...
module.exports = class CommandRunner {
	...
	_handleEvent(event) {
		const isCommandRecivedEvent = event.fullname === this.potok.events.commandReceived.fullname;
		...
		// awaitng any
		if (!isCommandRecivedEvent && this.callbacks.await.callbacks[anySymbol]) {
			this._clear(null, event);
			return;
		}
